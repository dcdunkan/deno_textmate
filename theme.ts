...
export class ThemeTrieElement {
  ...
  private static _cmpBySpecificity(
    ...
    if (a.scopeDepth === b.scopeDepth) {
      ...
      const aParentScopesLen = aParentScopes === null
        ? 0
        : aParentScopes.length;
      const bParentScopesLen = bParentScopes === null
        ? 0
        : bParentScopes.length;
  ...
  public match(scope: ScopeName): ThemeTrieElementRule[] {
    ...
    if (Object.prototype.hasOwnProperty.call(this._children, head)) {
